...
writeInfoLine(wordlabel$)
	if wordlabel$ = selectedword$
		...
		do("Save as WAV file...", directory$ + filename$ + ".w" + wordlabel$ + ".wav")
		...
		do("Save as EPS file...", directory$ + filename$ + ".w" + wordlabel$ + ".eps")
