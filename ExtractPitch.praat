...
header$ = "soundlabel" + tab$ + "start" + tab$ + "end" +  tab$ + "precedingSegment"+  tab$ + "followingSegment"+  tab$ + "meanPitch"
# + tab$ + "pitchRange"
...
repeat
	...
	if length(	soundlabel$) > 2
		...
		line$ = soundlabel$ + tab$ + st$ + tab$ + et$ + tab$ + precedingsegment$ + tab$ + followingsegment$ + tab$ + meanPitch$
